...
<form action="{!!route('caja', $cajas->id_caja)!!}" method="POST">
    @method('PATCH')
    @csrf
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="total_pos" id="total_pos" readonly value="Lps. {{$pos}}" >
            </div>
            <div class="form-group">
              <label for="codigo_compra">*Total Vendido EFECTIVO</label>
              <input type="text" class="form-control" name="total_efectivo" id="total" readonly value="Lps. {{$efectivo}}" >
            </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="total" id="total" readonly value="Lps. {{$total}}" >
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="pos" id="pos" placeholder="Ingrese el monto" >
          </div>
          <div class="form-group">
            <label for="caja">*Total en Efectivo</label>
            <input type="text" class="form-control" name="caja" id="caja" placeholder="Ingrese el monto" >
          </div>
