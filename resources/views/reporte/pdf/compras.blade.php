...
@endsection 
@section('content')
<form action="{!!route('compraDiaExport')!!}" method="GET">
@csrf
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-dark">
                <div class="card-header">
                  <h3 class="card-title">Fecha Unica</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                            <label for="fecha">Fecha en especifico</label>
                             <input class="form-control" name="fecha" onclick="fecha()" placeholder="Seleccione Fecha" value="" type="date" data-date-format="aaaa/mm/dd" id="fecha">
                        </div>
                      </div>
                    </div>
                  </div>
...
<form action="{!!route('compraRangoExport')!!}" method="GET">
@csrf
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-dark">
                <div class="card-header">
                  <h3 class="card-title">Rango de Fecha (90 dias max.)</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
...
<form action="{!!route('compraCreditoExport')!!}" method="GET">
@csrf
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-dark">
                <div class="card-header">
                  <h3 class="card-title">Creditos sin Pagar a la Fecha</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
